...
`D:\AI\AdobePlugin\Bridge\creative-asset-catalog-metadata-shelf`
...
4. Bridge のホスト上で panel または script shell が読み込めることを確認する。
...
- docs ZIP が `dist/creative-asset-catalog-metadata-shelf-docs.zip` に存在する。
