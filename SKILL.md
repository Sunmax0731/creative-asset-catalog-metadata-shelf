...
制作素材カタログ・メタデータ棚 を保守するときの実行ガイドです。

## Start Order

1. `README.md` を読む。
2. `docs/source-idea-pack.json` で PICKUP 行、created_idea、ZIP、host inference を確認する。
...
- docs ZIP は `dist/creative-asset-catalog-metadata-shelf-docs.zip` に再生成する。
